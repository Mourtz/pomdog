...
template <typename T> constexpr T TwoPi      = T{6.28318530717958647692};
template <typename T> constexpr T OneOverPi  = T{0.31830988618379067154};
template <typename T> constexpr T OneOver2Pi = T{0.15915494309189533576};
template <typename T> constexpr T PiOver2    = T{1.57079632679489661923};
template <typename T> constexpr T PiOver4    = T{0.78539816339744830962};
